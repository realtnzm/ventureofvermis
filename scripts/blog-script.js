...
let blogName = "Mini-essays";
let authorName = "tnzm";
let authorLink = "https://instagram.com/realtnzm"; // Enter your website, social media, etc. Some way for people to tell you they like your blog! (Leaving it empty is okay too)
...
let postsArray = [
  ...
  ["posts/2026-04-22-Dissolving-into-everything-becoming-nothing.html"],
  ["posts/2026-01-09-Impermanence.html"],
  ["posts/2026-01-08-Presence-Joy-Isnt-The-Absence-Of-Pain.html"],
  ["posts/2025-05-06-&-Life-Goes-On.html"],
];
...
let footerHTML =
  "<hr><p> Blog built by vermis/realtnzm with <a href='https://zonelets.net/' target='_blank'>Zonelets</a>.</p>";
...
if (postsArray.length > recentPostsCutoff) {
  recentPostListHTML +=
    '<li class="moreposts" style="list-style-type: none;"><a href=' +
    relativePath +
...
if (postsArray.length < 2) {
  nextprevHTML = '<a href="' + relativePath + '/archive.html">All posts</a>';
} else if (currentIndex === 0) {
  prevlink = postsArray[currentIndex + 1][0];
  nextprevHTML =
    '<a href="' +
    relativePath +
    '/archive.html">All posts</a> | <a href="' +
    relativePath +
    "/" +
    prevlink +
    '">Previous Post \u00BB</a>';
